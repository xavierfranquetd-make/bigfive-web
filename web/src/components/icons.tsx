...
export const Logo = ({ size = 36, height }: IconSvgProps) => (
  <img
    src='/logo-estudiemas.png'
    alt='EstudieMás'
    style={{ height: size || height || 36, width: 'auto' }}
  />
);
